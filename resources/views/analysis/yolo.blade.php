...
<form action="/user/{{$user}}" method="post">
    ...
    <div class="jumbotron mt-5">
        <h1 class="display-4">Hello, Saya The Yolo</h1>
        <p class="lead">"Yolo memiliki karakter toleransi terhadap resiko yang tinggi supaya dapat
            memperoleh return tertinggi guna meraih tujuan investasi kamu."</p>
        <hr class="my-4">
