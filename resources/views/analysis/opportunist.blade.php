...
<form action="/user/{{$user}}" method="post">
    ...
    <div class="jumbotron mt-5">
        <h1 class="display-4">Hello, Saya The Opportunist</h1>
        <p class="lead">"The Opportunist  Kamu memiliki toleransi terhadap resiko
            yang cenderung rendah dimana return yang diharapkan minimal
            setara dengan suku bunga deposito dengan fluktuasi nilai pasar
            yang minimal untuk mencapai tujuan investasi kamu."</p>
        <hr class="my-4">
